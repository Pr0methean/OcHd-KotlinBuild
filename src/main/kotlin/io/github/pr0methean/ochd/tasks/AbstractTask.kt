...
abstract class AbstractTask<out T>(
    ...
    suspend fun cacheClearingCoefficient(): Double {
        var coefficient = if (!cache.isEnabled()) {
            ...
            // If this task has only one direct-dependent task, it's worth 1 point because it will clear a cache entry.
            // If it has 2 direct-dependent tasks, it's worth 1/4 point; if it has 3, it's worth 1/16 point, and so on.
            Math.scalb(1.0,
