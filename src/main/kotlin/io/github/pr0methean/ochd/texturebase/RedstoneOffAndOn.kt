...
suspend fun FlowCollector<FileOutputTask>.redstoneOffAndOn(ctx: TaskPlanningContext, baseName: String,
                                                           layers:
                                                       suspend LayerListBuilder.(redstoneStateColor: Color) -> Unit) {
